...
export const MegamenuPromotionalCard3 = () => {
  return (
    <div className='w-full shrink-0 overflow-hidden lg:w-87.5'>
      <div className='from-0 flex h-104 flex-col items-center justify-between rounded-lg bg-linear-to-b from-amber-600/15 via-amber-100/10 via-50% to-amber-300/10 to-100% p-4 pt-10 text-center'>
        <div>
