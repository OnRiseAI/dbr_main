...
const AccountSidebar = () => {
  ...
  return (
    <div className='border-border rounded-xl border p-4'>
      ...
      <h4 className='mb-0.5 text-lg font-semibold'>{demoUser.name}</h4>
      <p className='text-muted-foreground text-base font-light'>{demoUser.email}</p>
