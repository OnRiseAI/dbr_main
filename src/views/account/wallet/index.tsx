...
const steps = [
  ...
  },
  {
    ...
    description: 'On the payment page, select Use Shopix Wallet as your preferred option.',
    active: true
  },
  {
    number: 3,
    ...
    <div className='space-y-5'>
      ...
      <Card className='rounded-md py-3.5 shadow-none'>
        <CardContent className='space-y-2.5 px-3.5'>
          <div>
            <h4 className='mb-1 text-lg font-medium'>Shopix Wallet Credit</h4>
            <p className='text-muted-foreground text-sm font-medium'>Balance: $100.00</p>
          </div>
          <p className='text-muted-foreground text-base'>
            Your Shopix Wallet balance comes from referrals, special offers, and cashback. Use it within validity on
            orders above $500.
          </p>
        </CardContent>
      </Card>

      <h3 className='mb-3.5 text-xl font-semibold'>Benefits of Shopix Wallet</h3>
      ...
      <h3 className='text-xl font-semibold'>How to use Shopix Wallet</h3>
